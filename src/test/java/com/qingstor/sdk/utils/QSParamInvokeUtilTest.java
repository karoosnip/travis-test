...
public class QSParamInvokeUtilTest {
    ...
    public void testClassToModel() {
        ...
        Assert.assertEquals(outmodel.getClass().getName(), Bucket.PutBucketACLOutput.class.getName());
    }
    ...
    public void testOutputModel() {
        ...
        try {
            outmodel = (Bucket.PutBucketACLOutput) QSParamInvokeUtil.getOutputModel(Bucket.PutBucketACLOutput.class);
        } catch (QSException e) {
            e.printStackTrace();
        }
        Assert.assertEquals(outmodel.getClass().getName(), Bucket.PutBucketACLOutput.class.getName());
    ...
    public void testParam() {
        ...
        Map bodyParam =
                QSParamInvokeUtil.getRequestParams(instancesInput, QSConstant.PARAM_TYPE_BODYINPUTSTREAM);
