...
public class QSSignatureUtilTest {
	...
	public void testSignature() {
		...
		*/
		...
		String url = QSSignatureUtil.getAuth("QYACCESSKEYIDEXAMPLE", "wudajefiLSJDWIFJLSD", 
				"GET", "objectTest",queryParam, null);
	...
	public void testExpireString() {
		...
		String req2 = null;
		try {
			req1 = QSSignatureUtil.getObjectAuthRequestUrl(evnContext,
					"testzone", "bucketName",
					"objectName/dd.txt", 1000);
		} catch (QSException e) {
			e.printStackTrace();
		}
		Assert.assertEquals(req1.indexOf("https://bucketName.testzone.qingstor.com/objectName/dd.txt?") == 0, true);
	}
}
